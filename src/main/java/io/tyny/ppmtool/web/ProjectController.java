...
import io.tyny.ppmtool.services.MapValidationErrorService;
import io.tyny.ppmtool.services.ProjectService;
...
public class ProjectController {
	...
	public Iterable<Project> getAllProjects() {
		return projectService.findlAllProjects();
	}
